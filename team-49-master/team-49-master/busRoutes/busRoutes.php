...
<body>
	...
	<div class="rvt-box">
	  ...
	  <div class="rvt-box__body">
		<p class="rvt-m-all-remove">Indiana University has a handful of buses to carry students to and from campus from various locations.<br>
		Select a route from the drop down menu above to see where it will take you!</p>
	  </div>
