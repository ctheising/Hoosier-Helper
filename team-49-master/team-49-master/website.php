...
<body>
	...
	<div class="banner_img">
		<img src="sample-gates-banner.jpg">
	</div>
	<style>
		.banner_img {
			background-image: url(sample-gates-banner.jpg);
	...
	<div class="rvt-box">
	  <div class="rvt-box__header">
		<h1 class="rvt-ts-md">Welcome to Hoosier Helper</h1>
	  </div>
	  <div class="rvt-box__body">
		<p class="rvt-m-all-remove">
		<h1 class="rvt-ts-sm"><b>Find the best local restaurants in Bloomington</b></h1>
		Bloomington has a wide variety of restaurants including many different bars, 
			taverns, international cuisines, and food trucks. Most options are available for 
			curbside pickup or delivery, so don't worry about having to wait in line for a table. 
			Bars allow for table seating only at the moment due to Monroe county COVID-19 guidelines. 
			If you're looking for something new just take a stroll down Kirkwood and you will find 
			several good spots to grab a bite to eat!
		
		<h1 class="rvt-ts-sm"><b>Explore scenic areas</b></h1>
		Looking for a place to visit? Bloomington has many scenic areas on and around campus. 
			Bloomington offers a wide range of shopping centers and scenic outdoors locations like 
			Monroe Lake. Navigate to the Locations tab to view some popular spots.
		
		<h1 class="rvt-ts-sm"><b>Incoming Freshman?</b></h1>
		There are many things to do as a freshman at Indiana University. We are here to help 
			make the most out of your undergraduate career at Indiana University Bloomington. Some 
			things to consider: IU offers many intramural sports programs and study groups that allow 
			you to network and connect with new people. For more information on these topics, explore 
			Hoosier Helper.
	...
	<div class="rvt-box">
  		<div class="rvt-box__header">
    		<h1 class="rvt-ts-md">Use the map below to Virtually Explore Bloomington</h1>
  		</div>
  		<div class="rvt-box__body">
