...
if ($_SERVER["REQUEST_METHOD"] == "POST") {	
	$addquery = "INSERT INTO studyGroups (name, subject, location, day, time) VALUES ('$name', '$subject', '$location', '$day', '$time');";
	$result = mysqli_query($conn, $addquery);
}
?>
		<h1>Congratulations, you have successfully created a new study group!</h1>
		</br>
		</br>
