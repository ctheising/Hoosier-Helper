...
You can add users to have full access to the calendar to create their own event. Each user that creates an event, the created event will be invisible to others. 
 
You are able to add and remove categories manualy on the connection.php, see documentation.
...
- cal_quicksave.php (that saves the id of the user inserting data, only 1 row)
- session.php
- loader.php
