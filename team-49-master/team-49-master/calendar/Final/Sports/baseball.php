...
<nav class="rvt-menu" aria-label="Section navigation">
    <ul class="rvt-menu__list">
        ...
        <li class="rvt-menu__item">
            <a href="baseball.php" aria-current="page">Baseball</a>
        </li>
        <li class="rvt-menu__item">
...
<div style="width: 100%; float: left; background-color: white;">
    ...
    <div class="map">
        <p style="text-align: center;"><iframe width="800" height="500" style="border:0" loading="lazy" allowfullscreen src="https://www.google.com/maps/embed/v1/search?q=baseball%20fields%20near%20Bloomington%2C%20IN&key=AIzaSyCfv81kUYzwrWDdaF-S8zvC_Yd58bl7utU"></iframe>
    </div>
</div>
