...
<body>
    ...
    <nav class="rvt-menu" aria-label="Section navigation">
        <ul class="rvt-menu__list">
            <li class="rvt-menu__item">
                <a href="index.php" aria-current="page">Basketball</a>
            </li>
            <li class="rvt-menu__item">
    ...
    <div style="width: 100%; float: left; background-color: white;">
        ...
        <div class="map">
            <p style="text-align: center;"><iframe width="800" height="500" style="border:0" loading="lazy" allowfullscreen src="https://www.google.com/maps/embed/v1/search?q=basketball%20court%20near%20Bloomington%2C%20IN%2C%20USA&key=AIzaSyCfv81kUYzwrWDdaF-S8zvC_Yd58bl7utU"></iframe></p>
        </div>
    </div>
