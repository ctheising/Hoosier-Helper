...
if ($_SERVER["REQUEST_METHOD"] == "POST") {	
	$addquery = "UPDATE user SET biography='$bio', school='$school', major='$major', age='$age', year='$year', hometown='$hometown', dob='$dob' WHERE email='$_SESSION[user_email_address]'";
...
<nav class="rvt-menu" aria-label="Section navigation">
	  <ul class="rvt-menu__list">
		...
		<center>
		<div style="width: 70%; background-color: white; text-align: center;">
