...
<nav class="rvt-menu" aria-label="Section navigation">
	  <ul class="rvt-menu__list">
		...
		<li class="rvt-menu__item">
		  <a href="../profile-feature/profile.php" aria-current="page">Profile</a>
		</li>
	  </ul>
	</nav>
		...
		$sql = "SELECT fname, lname, biography, school, major, age, year, hometown, dob, email FROM user WHERE email='$_SESSION[user_email_address]'";
		$result= mysqli_query($conn, $sql);
				if ($result->num_rows > 0) {
			while($row = $result->fetch_assoc()) {		
			echo "<br><center><b> First Name:</b> ". $row["fname"]. "</center><br>";
			echo "<br><center><b> Last Name:</b> ". $row['lname']. "</center><br>";
			echo "<br><center><b> School:</b> ". $row['school']. "</center><br>";
			echo "<br><center><b> Major:</b> ". $row['major']. "</center><br>";
			echo "<br><center><b> Age:</b> ". $row['age']. "</center><br>";
			echo "<br><center><b> Year In School:</b> ". $row['year']. "</center><br>";
			echo "<br><center><b> Email:</b> ". $row['email']. "</center><br>";
			}
		} else {
			echo "No Results";
		}	
